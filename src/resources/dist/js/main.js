$(function() {
	...
	$('.js-get-used-assets').on('click', function(e) {
		var $this = $(this),
			postData = {
				usedAssetIds: $this.data('used-asset-ids')
			};
		...
		$.post(siteUrl + 'admin/asset-use/used-assets', postData, function(returnData) {
			...
			root.on('click', '.js-get-entries', function(e) {
				...
				$.post(siteUrl + 'admin/asset-use/entries', postData, function(returnData) {
